...
@endif
@if($user->canAccess('counterparties.view') || $user->canAccess('counterparties.*'))
<li>
    <a href="{{ route('admin.counterparties.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-primary-50 dark:hover:bg-slate-700 hover:text-primary transition-colors {{ request()->routeIs('admin.counterparties.*') ? 'bg-primary-50 dark:bg-slate-700 text-primary font-medium' : '' }}">
        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
        Контрагенты
    </a>
</li>
@endif
@if($user->canAccess('product-receipts.view') || $user->canAccess('product-receipts.*'))
<li>
    <a href="{{ route('admin.product-receipts.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-primary-50 dark:hover:bg-slate-700 hover:text-primary transition-colors {{ request()->routeIs('admin.product-receipts.*') ? 'bg-primary-50 dark:bg-slate-700 text-primary font-medium' : '' }}">
        <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg>
        Поступления
    </a>
</li>
