<x-admin-layout title="Добавить контрагента">
    <div class="max-w-2xl space-y-6">
        <h1 class="text-2xl font-semibold text-slate-800 dark:text-slate-100">Добавить контрагента</h1>

        <form action="{{ route('admin.counterparties.store') }}" method="POST" class="space-y-4 rounded-xl bg-white dark:bg-slate-800 p-6 border border-slate-200 dark:border-slate-700">
            @csrf
            <div>
            ...
            <div>
                ...
                <input type="text" name="iin" id="iin" value="{{ old('iin') }}"
                       class="w-full rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white focus:ring-primary focus:border-primary">
            ...
            <div>
                ...
                <input type="text" name="kbe" id="kbe" value="{{ old('kbe') }}"
                       class="w-full rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white focus:ring-primary focus:border-primary">
            ...
            <div>
                ...
                <input type="text" name="iik" id="iik" value="{{ old('iik') }}"
                       class="w-full rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white focus:ring-primary focus:border-primary">
            ...
            <div>
                ...
                <input type="text" name="bik" id="bik" value="{{ old('bik') }}"
                       class="w-full rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white focus:ring-primary focus:border-primary">
            ...
            <div>
                ...
                <textarea name="address" id="address" rows="3"
                       class="w-full rounded-lg border border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white focus:ring-primary focus:border-primary">{{ old('address') }}</textarea>
            ...
            <div class="flex gap-3 pt-4">
                <button type="submit" class="px-4 py-2 rounded-lg bg-primary text-white hover:bg-primary-600 transition-colors">Создать</button>
